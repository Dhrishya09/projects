...
import 'package:flutter_application_1/pages/user/homeuser_main.dart'; // Corrected import
...
Future<void> main() async {
  ...
  // Temporary test for API connectivity: log status from /status endpoint.
  BackendService.checkApiStatus().then((result) {

...
import 'package:flutter_application_1/pages/manager/bottom_nav_manager.dart';
...
import 'package:flutter_application_1/pages/settings/edit_profile_manager.dart';
    ...
    return Scaffold(
      appBar: AppBar(
        leading: IconButton(
          ...
          onPressed: () {
            // For a logged in manager, route to HomeManagerPage.
            // HomeManagerPage is expected to use BackendService.session.email and fetch dynamic details.
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => HomeManagerPage(email: BackendService.session.email ?? "")),
            );
          },
        ),
        title: Text(
            ...
            items: [
              SettingsItem(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const EditProfileManager()),
                  );
                },
              ),
              SettingsItem(
